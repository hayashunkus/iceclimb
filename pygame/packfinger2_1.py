...
COLORS = {
    ...
    'WALL': (50, 50, 200),          # 壁の色 (SHUNK文字)
    'PLAYER': (255, 255, 0),        # プレイヤー (黄色)
    'DOT': (255, 183, 174),         # エサ (ピンクベージュ)
    'ENEMY_RED': (255, 0, 0),       # 敵 (赤)
    'ENEMY_BLUE': (0, 0, 255),      # 敵 (青)
    'ENEMY_GREEN': (0, 255, 0),     # 敵 (緑)
    'TEXT': (255, 255, 255),        # テキスト色
    'CAMERA_FRAME': (100, 100, 100), # カメラ枠の色
    'BUTTON_START': (0, 180, 0),    # スタートボタン (緑)
    'BUTTON_RESET': (200, 50, 50),  # リセットボタン (赤)
    'BUTTON_TEXT': (255, 255, 255)  # ボタン文字色
}
