...
# カラーパレット (RGB)
COLORS = {
    'BACKGROUND': (0, 0, 0),         # 黒（コントラスト確保のため維持）
    'WALL': (0, 75, 150),            # CUDブルー（識別しやすい青）
    'PLAYER': (255, 255, 0),         # 黄（全色覚で最も明るく見える色）
    'DOT': (255, 255, 255),          # 白（エサの視認性を最大化）
    'ENEMY_RED': (255, 75, 0),       # CUDオレンジ（P型でも暗くならず赤に見える）
    'ENEMY_BLUE': (0, 100, 200),     # CUD空色（深みのある青）
    'ENEMY_GREEN': (0, 153, 115),    # CUD青緑（赤と混同しない緑）
    'TEXT': (255, 255, 255),         # 白
    'CAMERA_FRAME': (127, 135, 143), # CUDグレー
    'BUTTON_START': (0, 153, 115),   # CUD青緑（Goの合図として適切）
    'BUTTON_RESET': (255, 153, 0),   # CUDオレンジ（注意喚起。赤より識別しやすい）
